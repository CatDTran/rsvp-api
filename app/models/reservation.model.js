...
var ReservationSchema = new Schema({
  bookedBy: {
    ...
    name: {first: String, last: String} // For consitency, this field should be populated by pulling into from userId
  },
  bookedFor: {
    userId: Schema.Types.ObjectId,  // optional
    name: {first: String, last: String}
  },
  bookBelong: { type: Schema.Types.ObjectId, required: true}, // a reservation must belong to a rsvp book
  ...
  endTime: {type: Date, default: 30}// optional, should be calcualted from the service duration and startTime. Default value is 60 mins
